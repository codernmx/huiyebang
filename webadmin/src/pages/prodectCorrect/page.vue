	...
	<a-card>
		...
		<div>
			...
			>
				...
				<div slot="attachmentlot" slot-scope="{text}">
					<img style="width:60px;" :src="text" />
				</div>
				
				<div slot="action" slot-scope="{text, record}">
					<router-link :to="{path:'/prodect/prodectCorrectDetail',query: { ct_id: record.ct_id}}" :key="record.ct_id">
	...
	export default {
		...
		methods: {
			init() {
				...
				API.compositioncorrection_page(this.query).then(res => {

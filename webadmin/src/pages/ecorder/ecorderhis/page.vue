            ...
            >
                ...
                <div slot="action" slot-scope="{text, record}">
                    <a style="margin-right: 8px">
                        <router-link :to="{path:'/ecorderhis/EcOrderHisDetail',query:  {order_id: record.order_id}}">
    ...
    export default {
        ...
        methods: {
            init() {
                ...
                API.ecorderhis_page(this.query).then(res => {
            ...
            updateEcOrderHis(data) {
                API.ecorderhis_update(data).then(res => {
                    if (res.data.status == 0) {
            ...
            deleteEcOrderHis(data) {
                API.ecorderhis_delete(data).then(res => {
                    if (res.data.status == 0) {
                        this.$message.success(res.data.msg)
                    }
                    this.init()
